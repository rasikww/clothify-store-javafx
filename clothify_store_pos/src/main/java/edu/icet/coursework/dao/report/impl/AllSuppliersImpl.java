...
public class AllSuppliersImpl implements ReportBehaviour {
    @Override
    public boolean generate(Report report) {
        Session session = HibernateUtil.getInstance().getSession();
        boolean isGenerated = false;
        try {
            JasperDesign jasperDesign = JRXmlLoader.load("src/main/resources/reports/all_suppliers_details.jrxml");
