...
public class ProductCatalogImpl implements ReportBehaviour {
    @Override
    public boolean generate(Report dto) {
        Session session = HibernateUtil.getInstance().getSession();
        boolean isGenerated = false;
        try {
            JasperDesign jasperDesign = JRXmlLoader.load("src/main/resources/reports/product_info.jrxml");
